...
const UpdateUser = () => {
    ...
    const {itemId, staff } = route.params;
    ...
    const executeNewUser = useCallback(() => { 
        fetch('https://crudcrud.com/api/b7b6cf0863384a46ab32d41ea3b24eff/zamara/'+itemId, {
            method: 'PUT',
    ...
    }, [staffname, staffnumber, staffemail, department, salary]);
    ...
    return(
        <View style={styles.container}>
            ...
            <Pressable style={styles.button} onPress={() => executeNewUser()}>
                <Icon name="edit" size={20} color={iconColor} />
